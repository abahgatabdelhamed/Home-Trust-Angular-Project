...
export class AccountService {
    ...
    getUsersForReport(page?: number, pageSize?: number) {

        return this.accountEndpoint.getUsersForReportEndpoint<User[]>(page, pageSize);
    }
    getAllgroup(){
        return this.accountEndpoint.getAllgroupEndpoint()
    }
    ...
    uploadFile(item: any,me?:boolean) {
        return this.accountEndpoint.uploadFile(item,me);
    }
