...
export class UsersManagementComponent implements OnInit, AfterViewInit {
    ...
    addNewUserToList() {
        if (this.sourceUser) {
            ...
            this.rowsCache.push(undefined);
            this.rowsCache = this.rowsCache.slice(0, -1);
    ...
    onDataLoadFailed(error: any) {
       // this.alertService.stopLoadingMessage();
        ...
        // this.alertService.showStickyMessage(this.gT("messages.loadError"), `Unable to retrieve users from the server.\r\nErrors: "${Utilities.getHttpResponseMessage(error)}"`,
        ...
        this.accountService.deleteUser(row)
            ...
            error => {
               // this.alertService.stopLoadingMessage();
                ...
                // this.alertService.showStickyMessage(this.gT("messages.deleteError"), `An error occured whilst deleting the user.\r\nError: "${Utilities.getHttpResponseMessage(error)}"`,
                //     MessageSeverity.error, error);
            });
    }
