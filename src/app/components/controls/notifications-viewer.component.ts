         ...
         //       this.alertService.stopLoadingMessage();
            ...
            error => {
               // this.alertService.stopLoadingMessage();
                this.loadingIndicator = false;
/*
                this.alertService.showMessage(this.gT("messages.loadError"), "Loading new notifications from the server failed!", MessageSeverity.warn);
                this.alertService.logError(error);
*/
                if (this.dataLoadingConsecutiveFailurs++ < 5)
                    setTimeout(() => this.initDataLoading(), 5000);
                //else
                   // this.alertService.showStickyMessage(this.gT("messages.loadError"), "Loading new notifications from the server failed!", MessageSeverity.error);
        ...
        this.notificationService.deleteNotification(row)
            ...
            error => {
              //  this.alertService.stopLoadingMessage();
                ...
                /*this.alertService.showStickyMessage(this.gT("messages.deleteError"), `An error occured whilst deleting the notification.\r\nError: "${Utilities.getHttpResponseMessage(error)}"`,
