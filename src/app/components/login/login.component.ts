                ...
                setTimeout(() => {
                    ...
                    if (!this.isModal) {
                       this.alertService.showMessage( this.gT("app.Login"),
                        this.gT("app.Welcome")+ ` ${user.userName}!`, MessageSeverity.success);
                        
                        
                    }
                    else {
                        this.alertService.showMessage(this.gT("app.Login"), `Session for ${user.userName} restored!`, MessageSeverity.success);
                        setTimeout(() => {
