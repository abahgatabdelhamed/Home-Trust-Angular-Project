...
<span class="">${((bill['serviceTotalWithoutVat'] - this.allDiscount(bill)).toFixed(2))} ريال </span>
...
<span class="">${+bill['totalVat'].toFixed(2)} ريال </span>
  ...
  <span class="">${+this.alltobaaccoVat.toFixed(2)}  ريال </span>
    ...
    <span class="">${Math.round(bill['serviceTotalWithVat']*100)/100} ريال </span>
  </th>
</tr>
      <tr>
...
`}
      ...
      <span class="" >الخصم  </span>
       ...
       <tr>
           ...
           <th colspan="1" class="inline" style="text-align: center;">
           <span class="">${bill.totalAfterDiscount ? (Math.round((bill['serviceTotalWithVat'] - bill['discount'])*100)/100 )+' ريال'  : ''}</span>
         </th>    </th>
