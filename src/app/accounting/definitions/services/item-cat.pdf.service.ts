...
@Injectable()
export class ItemCatPDFService extends EndpointFactory {
    ...
    <div class="pr-item">
      <p class="label right">اسم النوع الأب : </p>
      <p class="left">${doc.itemCategoryParentName? doc.itemCategoryParentName: 'ليس له أب'}</p>
    </div>
    <div class="pr-item">
